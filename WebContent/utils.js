...
//dialogFadeIn = function(dialog, around, orient){
//	dojo.removeClass(dialog.domNode, "fadeOut");
//	dojo.removeClass(dialog.domNode, "fadeIn");
//	dojo.addClass(dialog.domNode, "fade");
//	dojo.addClass(dialog.domNode, "fadeIn");
//	dijit.popup.open({
//		popup : dialog,
//		around : around,
//		orient : orient
//	});
//}
//dialogFadeout = function(dialog){
//	dojo.removeClass(dialog.domNode, "fadeIn");
//	dojo.addClass(dialog.domNode, "fadeOut");
//	setTimeout(function(){dijit.popup.close(dialog);}, 1500);
//}
utils ={
  ...
  queryParams : function(){
    var o ={};
    window.location.search.substr(1).split('&').map(function(p){return p.split('=')}).forEach(function(a2){o[a2[0]] = a2[1];});
    return o;
  }
};
